          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?php echo $_SESSION['gudang_name']; ?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index_barang.php">Dashboard</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="kelola_barang.php">Kelola Barang</a></li>
                      <li><a href="pengadaan_barang.php">Pengadaan Barang</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/user.png" alt=""><?php echo $_SESSION['gudang_name']; ?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Inventory <small>Kelola Barang</small></h3>
                  </div>
                  ...
                  <div class="col-xs-4">
                      ...
                      <form action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="selectpicker" name="id_option">
                      ...
                      <?php
                        if(isset($_GET['edit'])){
                          $id_barang = $_GET['edit'];
                          include "../includes/update_barang.php";
